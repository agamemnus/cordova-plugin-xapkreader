...
public class XAPKReader extends CordovaPlugin {
 ...
 @Override public void initialize (final CordovaInterface cordova, CordovaWebView webView) {
  ...
  if (
   ...
   // We need this permission, so request it (asynchronously: callback is onRequestPermissionsResult).
 ...
 public void onRequestPermissionResult (int requestCode, String[] permissions, int[] grantResults) throws JSONException {
  for (int r:grantResults) {
   // The permission WRITE_EXTERNAL_STORAGE (and implicitly, READ_EXTERNAL_STORAGE) is granted.
